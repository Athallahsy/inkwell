    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0"
            ...
            <div class="modal-body"
                 style="padding:26px; background:#fcfbf9;">
                    ...
                    <div class="mb-4">
                        ...
                        <div style="display:flex; gap:12px;">
                            ...
                            <label style="flex:1; cursor:pointer;">
                                ...
                                <div style="
                                    padding:12px 14px;
                                    border:1px solid {{ $item->role == 'admin' ? '#92400e' : '#e7e5e4' }};
                                    border-radius:10px;
                                    background:{{ $item->role == 'admin' ? '#fff7ed' : '#ffffff' }};
                                    text-align:center;
                                    font-size:.85rem;
                                    font-weight:600;
                                    color:#1c1917;
                            ...
                            <label style="flex:1; cursor:pointer;">
                                ...
                                <div style="
                                    padding:12px 14px;
                                    border:1px solid {{ $item->role == 'user' ? '#92400e' : '#e7e5e4' }};
                                    border-radius:10px;
                                    background:{{ $item->role == 'user' ? '#fff7ed' : '#ffffff' }};
                                    text-align:center;
                                    font-size:.85rem;
                                    font-weight:600;
                                    color:#1c1917;
