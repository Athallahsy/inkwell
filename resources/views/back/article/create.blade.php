...
<main class="col-md-9 ms-sm-auto col-lg-10 ink-content">
    ...
    <div class="ink-page-header">
        <div>
            ...
            <h1 class="ink-page-title">Create Article</h1>
        </div>
    </div>
    ...
    <div class="ink-card">
        <form action="{{ url('/article') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="ink-form-group">
                        <label for="title" class="ink-label">Title</label>
                        <input
                            type="text"
                            name="title"
                            id="title"
                ...
                <div class="col-md-6">
                    <div class="ink-form-group">
                        <label for="category_id" class="ink-label">Category</label>

                        <select name="category_id" id="category_id" class="ink-select">
            ...
            {{-- Description --}}
            <div class="ink-form-group">
                <label for="desc" class="ink-label">Description</label>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ink-form-group">
                        <label for="status" class="ink-label">Status</label>

                        <select name="status" id="status" class="ink-select">
                            <option value="" hidden>
                                -- choose status --
                            </option>
            ...
            <div class="d-flex justify-content-end mt-4">
                <button type="submit" class="ink-btn ink-btn-primary">
                    Save Article
                </button>
            </div>
        </form>
